...
export default function Edit({ property, dropdown_options }) {
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        marketing_title: property.marketing_title || '',
        description: property.description || '',
        primary_view: property.primary_view || '',
        secondary_view: property.secondary_view || '',
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <Link 
                                        ...
                                        target="_blank"
                                    >
                                        <i className="bi bi-eye me-2"></i> View Property
                                    </Link>
                                </div>
                            </div>
                            
                            {success && (
                                <div className="alert alert-success" role="alert" style={{ fontFamily: 'Glancyr' }}>
                                    <i className="bi bi-check-circle me-2"></i> Property updated successfully!
                                </div>
                            )}
