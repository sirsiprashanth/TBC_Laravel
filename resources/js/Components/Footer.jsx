                ...
                <div className="row">
                    <div className="col-md-12 mb-4">
                        ...
                        <div className="d-flex justify-content-end mb-4">
                            <Link href="#" className="text-white mx-3" style={{ textDecoration: 'none' }}>Buy</Link>
                            <Link href="#" className="text-white mx-3" style={{ textDecoration: 'none' }}>Sell</Link>
                            <Link href="#" className="text-white mx-3" style={{ textDecoration: 'none' }}>Rent</Link>
                            <Link href="#" className="text-white mx-3" style={{ textDecoration: 'none' }}>Off-Plan</Link>
                            <Link href="#" className="text-white mx-3" style={{ textDecoration: 'none' }}>About Us</Link>
                        </div>
                    </div>
